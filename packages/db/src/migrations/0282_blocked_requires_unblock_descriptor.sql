-- BLA-687. Numbered 0282 because this fork was rebased onto upstream/master,
-- which had already claimed 0228, 0234, 0238, and 0280 (numbers this migration
-- carried across earlier syncs before upstream caught up past each one).
-- The IF EXISTS guard below lets the renumbered file re-run harmlessly
-- against a fork database that already applied it under one of the old
-- numbers.
--
